...
invented one. This skill is new (2026-07-16/17 batch) and its block still reads `pending` — that
stays until the maintainer's first sweep records a real result.
